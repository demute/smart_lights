...
void RunStartup(void)
{
    ...
    // dprintf("Voltage: %.2f (%s powered)", BatteryVoltage(), BatterySource()); // FIXME: BatteryVoltage function in mbed-util.S line 496 interferes with other usage of adc, don't run it.
